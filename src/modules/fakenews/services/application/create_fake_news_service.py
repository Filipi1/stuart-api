...
class CreateFakeNewsService:
    ...
    def __init__(
        ...
        headline_generator_service: HeadlineGeneratorService,
    ):
    ...
    def execute(self, request: CreateFakeNewsRequestDto) -> CreateFakeNewsResponseDto:
        try:
            headline, subtitle = self.headline_generator_service.generate_headline(
                request.name
            )
            ...
            fake_news_image = self.image_builder_service.create_fake_news_image(
                image_data=image_data, headline=headline, subtitle=subtitle
            )
