from modules.user.dtos.fetch_user_by_username import FetchUserByUsernameRequestDto, FetchUserByUsernameResponseDto
...
class FetchUserByUsernameApplicationService(ApplicationService):
    ...
    async def process(self, input: FetchUserByUsernameRequestDto) -> FetchUserByUsernameResponseDto:
